=== Techspace - User Profile & Membership Plugin ===
...
Techspace is the #1 user profile & membership plugin for WordPress. The plugin makes it a breeze for users to sign-up and become members of your website. The plugin allows you to add beautiful user profiles to your site and is perfect for creating advanced online communities and membership sites. Lightweight and highly extendible, Techspace will enable you to create almost any type of site where users can join and become members with absolute ease.
...
Read about all of the plugin's features at [Techspace](https://ultimatemember.com)

= Paid Extensions =

Techspace has a range of extensions that allow you to extend the power of the plugin. You can purchase all of these extensions at a significant discount with our [All Access Pass](https://ultimatemember.com/pricing/) or you can purchase extensions individually.
...
* [WooCommerce](https://ultimatemember.com/extensions/woocommerce/) - Allow you to integrate WooCommerce with Techspace
...
* [bbPress](https://ultimatemember.com/extensions/bbpress/) - With the bbPress extension you can beautifully integrate Techspace with bbPress
...
* [myCRED](https://ultimatemember.com/extensions/mycred/) - With the myCRED extension you can integrate Techspace with the popular myCRED points management plugin
...
Our official [theme](https://ultimatemember.com/theme/) is purpose built for websites that have logged in and out users. The [theme](https://ultimatemember.com/theme/) has deep integration with Techspace plugin and the extensions, different header designs for logged-in/out users and works alongside the Beaver Builder and Elementor page builders.
...
Want to add a new language to Techspace? Great! You can contribute via [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-member).
...
Got a problem or need help with Techspace? Head over to our [documentation](http://docs.ultimatemember.com/) and perform a search of the knowledge base. If you can’t find a solution to your issue then you can create a topic on the [support forum](https://wordpress.org/support/plugin/ultimate-member).


== Installation ==

1. Activate the plugin
2. That's it. Go to Techspace > Settings to customize plugin options
...
No, we have built Techspace to be extremely easy to use and does not require you to manually build shortcodes or have any coding knowledge.

= Is Techspace mobile responsive? =

Yes. Techspace is designed to adapt nicely to any screen resolution. It includes specific designs for phones, tablets and desktops. 

= Is Techspace multi-site compatible? =

Yes. Techspace works great on both single site and multi-site WordPress installs.

= Does the plugin work with any WordPress theme? =

Yes. Techspace will work with any properly coded theme. However, some themes may cause conflicts with the plugin. If you find a styling issue with your theme please create a post in the community forum.

= Does the plugin work with caching plugins? =

The plugin works with popular caching plugins by automatically excluding Techspace pages from being cached. This ensures other visitors to a page will not see the private information of another user. However, if you add features of Techspace to other pages you have to exclude those pages from being cached through your cache plugin settings panel. 
...
* Enhancements:
  ...
  * Adds new action hook in admin > user edit > Techspace to append any customisation
...
* New: Important: Introduces the Techspace RESTful API
...
* New: addon to transfer BuddyPress profile photos to Techspace (user request)
...
* New: A more native dashboard for Techspace
