...
if ( ! class_exists( 'um\admin\core\Admin_Settings' ) ) {
	...
	class Admin_Settings {
				...
				'misc'          => array(
					...
					'fields'      => array(
						...
						array(
							...
							'tooltip'   => __( 'Check this box if you would like to disable Techspace user\'s cache.', 'ultimate-member' ),
						),
						array(
							'id'       		=> 'uninstall_on_delete',
							'type'     		=> 'checkbox',
							'label'   		=> __( 'Remove Data on Uninstall?', 'ultimate-member' ),
							'tooltip'	=> __( 'Check this box if you would like Techspace to completely remove all of its data when the plugin/extensions are deleted.', 'ultimate-member' ),
						)
					)
				),
				'install_info'  => array(
		...
		function settings_page() {
			...
			echo '<div id="um-settings-wrap" class="wrap"><h2>' .  __( 'Techspace - Settings', 'ultimate-member' ) . '</h2>';
