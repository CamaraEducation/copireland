...
Tags: Techspace Chat, live support, chat plugin, live help, wordpress Techspace Chat, chat, Techspace Chat plugin, live support plugin, Techspace Chat support plugin, chat plugin, support plugin, live help
...
Fully functional Techspace Chat plugin. Chat with your visitors for free! No need for monthly payments. Add Techspace Chat support to your site now.

== Description ==

The most cost effective Techspace Chat plugin. Chat with your visitors for free! Techspace Chat is perfect for small businesses. There's no need to pay for Techspace Chat monthly subscriptions in order to better understand your visitors. This is a fully functional Techspace Chat plugin. Increase your conversion rates by communicating directly with your visitors when they're ready to do so using Techspace Chat.

= Free Version Features =

* Most popular WordPress chat plugin
* Techspace Chat is a fully functional Techspace Chat plugin
* Unlimited simultaneous Techspace Chats
* Techspace Chat directly with your visitors
* Easy to use interface for both the admin and the visitor
* Edit all text fields shown on the Techspace Chat box
* Users can drag the Techspace Chat box around their page
* Change the colors of the Techspace Chat box
* Fully responsive admin chat dashboard
* Offline messages are now stored (When Techspace Chat is switched off)
* 6 predefined Techspace Chat box themes to choose from
* Fully customizable Techspace Chat experience
* Apply animations to the chat window
* Access historical Techspace Chat records
* Use our new powerful Node.js message relay server to improve performance of your Techspace Chats
...
* GIF integration
* No monthly Techspace Chat subscriptions needed
* Allow the Techspace Chat box to automatically pop up
* Limit the Techspace Chat box to only show to registered users
* Compatible with all caching plugins (Techspace Chat window loaded via Ajax)
* Desktop Notifications when receiving new Techspace Chats
* View any Techspace Chats you may have missed
* Set the starting position of your chat box
* Comprehensive list of Techspace Chat options
* Enable/Disable the chat box on mobile devices
* Enable/Disable the sound when a new Techspace Chat message is received
...
= Extend the functionality of Techspace Chat with the Techspace Chat Pro =

* Unlimited Techspace Chat agents
* Initiate Techspace Chats with online visitors
...
* Quick Responses (insert a predefined response to your Techspace Chat box)
...
* Add your company logo to the Techspace Chat window
* Add your photo to the Techspace Chat window
* Edit all text fields shown on the Techspace Chat box
* Include/exclude the Techspace Chat from appearing on certain pages
* Fully customizable Techspace Chat experience
* Choose when to accept chats
* World-class support

Get the [Techspace Chat Pro Add-on](http://wp-livechat.com/purchase-pro/?utm_source=readme&utm_medium=wordpress&utm_campaign=buy) for a once off payment!

= Extend the functionality of Techspace Chat with the Techspace Chat Mobile/Desktop App Extension =
...
Get the [Techspace Chat Mobile/Desktop App Extension](https://wp-livechat.com/extensions/mobile-desktop-app-extension/?utm_source=readme&utm_medium=wordpress&utm_campaign=buy_app) now!
...
= 30 second Techspace Chat installation =

Our Techspace Chat plugin instantly gives you the ability to chat directly with potential clients and/or website visitors when they're ready to do so. Initiate a Techspace Chat with a certain visitor or wait for them to initiate a Techspace Chat with you. Increase your website conversion rates by providing real time live support.

= Quick Overview =

Once the Techspace Chat plugin is activated, click on "Techspace Chat" in the left menu navigation. As soon as a visitor lands on your website, their details will be displayed in the Techspace Chat control panel. A Techspace Chat box will be displayed on their screen. If they fill out their details and click "Start chat", a ringing sound will trigger in your Techspace Chat control panel. Once you accept the chat, you can communicate directly with your visitor.

= Using Techspace Chat effectively on your website =
One of the most important tasks of your website is to educate potential customers of your product and/or service. By having a Techspace Chat window on your website, this gives you the opportunity to do this.

* Techspace Chat is convenient for customers
* Techspace Chat builds trust with your potential customers
* Increase sales by using Techspace Chat
* Take advantage of a fully functional Techspace Chat plugin for free.
* Reduce costs by using Techspace Chat on your website with minimum staff
* Learn to understand the pain points of your customers

= Have the choice to use your website or our server to host your Techspace Chat =

You now have the choice to host your Techspace Chat on either your own website (using your own resources) or our Techspace Chat server (using our resources). Making use of our Techspace Chat server will improve your chat's performance by up to 300% and reduce the load on your host. Although we initially built our Techspace Chat plugin to be used on your own website and for you to host your own Techspace Chat server, we now offer you the ability to make use of an offsite Techspace Chat server - this is perfect for users that are on low-level hosting packages, or users that are more concerned about Techspace Chat performance and chat security.

= Translations =
Get a free copy of one of the premium Techspace Chat extensions in exchange for translating our plugin!
...
1. Once activated, click the "Techspace Chat" link under your settings tabs.
...
= I've installed the Techspace Chat plugin, now what? =
Once installed and activated, a link should appear in your left navigation panel within your WP-ADMIN section. Click on the "Techspace Chat" link and follow the on screen instructions.

= Where can I find documentation for Techspace Chat? =
Please review the Techspace Chat documentation on [our website](http://wp-livechat.com/documentation/).

= Does Techspace Chat connect to a third party server? =
No. Techspace Chat was developed to specifically create and manage Techspace Chats on your server. Installing this plugin will essentially turn your website into it's own Techspace Chat server. We have put every effort into making this process as smooth as possible while ensuring low resource usage on your host. We have incorporated long polling into the Techspace Chat functionality which ensures a quick chat response time between the admin and the user while maintaining a low resource footprint.

= What are desktop notifications? =
Desktop notifications are notifications that will appear on the bottom right of your screen when a new Techspace Chat is received. This feature is supported in all browsers except Internet Explorer.

= Can my visitors start a Techspace Chat without entering their name and email address? =
Yes. This option is available on the Techspace Chat settings page.

= Can I disable the Techspace Chat window on mobile devices? =
Yes. You can show or hide the Techspace Chat window on mobile devices. This includes mobile phones and tablets.

= How does Techspace Chat notify me of an incoming Techspace Chat? =
You will be notificed of a new Techspace Chat by means of email, audio and desktop notifications.

= Can I show the Techspace Chat window to registered users only? =
Yes. You can limit the Techspace Chat window to show to users that are registered and logged in to your site. 

= Can I specify a user role to my Techspace Chat agent? =
Unfortunately not. The administrator of the site is the default Techspace Chat agent. The Pro add-on allows for an unlimited number of Techspace Chat agents.

= Can I see if I missed any Techspace Chats that I may not have answered in time? =
Yes. To view the list of Techspace Chats you missed, go to 'Techspace Chat' -> 'Missed Chats'

= Troubleshooting =
If you're experiencing issues running Techspace Chat, please take note of the following:

- The Techspace Chat box will only show up on the front end if you are logged in to your wp-admin section.
- The default delay before the Techspace Chat box appears is 10 seconds. You can change this on the settings page.
- If you press the "X" within the Techspace Chat window on the front end, a cookie will be set that will stop the chat box from showing for another 24 hours.

If the Techspace Chat box still does not appear on your website, please go through the following steps:
...
1. Front-end of Techspace Chat
2. Back-end of Techspace Chat
3. Settings page of Techspace Chat
4. "Leave a message" functionality available in Techspace Chat
5. Initiate a Techspace Chat with a visitor on your website (extension required)


== Upgrade Notice ==

= 8.0.20 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.20 for performance reasons.

= 8.0.18 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.18 for security reasons.

= 8.0.15 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.15 for security reasons.

= 8.0.12 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.12 for stability reasons.

= 8.0.11 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.11 if using PHP 5.3 or below.

= 8.0.09 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.09 for GDPR compliance.

= 8.0.08 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.08 for security reasons.

= 8.0.06 =
It is highly recommended that you upgrade to Techspace Chat version 8.0.06 for security reasons.

= 7.1.07 = 
It is highly recommended that you upgrade to Techspace Chat version 7.1.07 for security reasons.

= 7.1.05 = 
It is highly recommended that you upgrade to Techspace Chat version 7.1.05 for security reasons.

= 7.1.03 = 
It is highly recommended that you upgrade to Techspace Chat version 7.1.04 for security reasons.
...
* Modernised the Techspace Chat box
...
* Added 'Device' type logging to Techspace Chat dashboard area. 
...
* Added compatibility for Techspace Chat triggers
...
* Fixed the bug that caused "start chat" to be added to the button in the Techspace Chat box when offline
...
* Added a new filter to fix a bug with Techspace Chat - Advanced Chat Box Control Extension

= 6.0.01 - 2016-02-02 - High priority =
* Crucial bug fix that stopped the Techspace Chat from working in some instances
* New filter to fix the bug with the Techspace Chat Choose When Online bug
...
* Many of the Techspace Chat Pro features have been moved into the free version

= 5.0.14 - 2016-01-13 - High priority =
* Bug fix: When activating Techspace Chat, a table is created with a shared MySQL column name which caused issues on some servers. The column name has been changed
* Techspace Chat Pro users need to update to the latest version when using this version (there is a notice for this in the Techspace Chat dashboard)
...
* Changes to the Techspace Chat extensions page

= 5.0.9 - 2015-10-09 - Low priority =
* New hook: wplc_hook_admin_menu_layout - Target the area above the normal menu layout
* Style bug fix with the "DATA" section of the Techspace Chat dashboard

= 5.0.8 - 2015-10-07 - Low priority =
* Introduced new custom Techspace Chat hooks:
*  wplc_hook_admin_visitor_info_display_before - Allows you to add HTML at the beginning of the vistior details DIV in the Techspace Chat window
*  wplc_hook_admin_visitor_info_display_after - Allows you to add HTML at the end of the vistior details DIV in the Techspace Chat window
*  wplc_hook_admin_javascript_chat - Allows you to add Javascript enqueues at the end of the javascript section of the Techspace Chat window
...
*  wplc_hook_admin_settings_save - Hook into the save settings head section. i.e. where we handle POST data from the Techspace Chat settings page 

= 5.0.7 - 2015-10-06 - Low priority =
* Added a Techspace Chat extension page
* Corrected internationalization

= 5.0.6 - 2015-09-17 - Low Priority =
* You can now choose to disable the sound that is played when a new Techspace Chat message is received
* Fixed a bug that caused some chat settings to revert back to default when updating the plugin
* Updated all Techspace Chat translation files

= 5.0.5 - 2015-09-09 - Low Priority =
* Fixed a bug that displayed an error message to update the Techspace Chat plugin while using the latest version (Pro)
* Fixed a bug where the mobile detect class would only work if the Pro was enabled
* Fixed a bug where the Techspace Chat window would move to the bottom left of the page when being minimized
* You can now see the visitors IP address on the Techspace Chat dashboard
* Alert message removed when a user was made a Techspace Chat agent on the settings page (Pro)
* Fixed a bug that would prevent the user from typing if they had a previous Techspace Chat session (Pro)

= 5.0.4 - 2015-08-06 - Medium Priority =
* Techspace Chat is now compatible with all caching plugins
...
* Fixed a bug that caused a fatal error with older versions of Techspace Chat Pro

= 5.0.1 - 2015-08-05 - Medium Priority =
* Refactored the code so that the Techspace Chat box will show up even if there is a JS error from another plugin or theme
* Techspace Chat box styling fixes: top image padding; centered the "conneting, please be patient" message and added padding
* The Techspace Chat long poll connection will not automatically reinitialize if the connection times out or returns a 5xx error

= 5.0.0 - Doppio Update - 2015-07-29 - Medium Priority =
* New, modern chat dashboard 
* Better user handling (chat long polling)
* Added a welcome page to the Techspace Chat dashboard
...
* Bug fixes in the javascript that handles the Techspace Chat controls
* Fixed the bug that stopped the chats from timing out after a certain amount of time

= 4.4.4 - 2015-07-20 - Low Priority =
* Bug Fix: Big fixed that would cause the Techspace Chat to timeout during a conversation
...
* Improvement: Hungarian Techspace Chat translation file name fixed
* Improvement: Styling improvements on the Techspace Chat dashboard
* New Translations:
...
* Enhancement: Provision made for Techspace Chat encryption in the Pro version (compatibility)
...
* Enhancement: Stying improvement on the Techspace Chat dashboard
...
* New Techspace Chat Translation added:
*  Greek (Thank you Peter Stavropoulos)

= 4.2.6 2015-01-29 - Low Priority =
* New feature: Techspace Chat dashboard has a new layout and design
* Code Improvement: jQuery Cookie updated to the latest version
* Code Improvement: More Techspace Chat strings are now translatable 
* New Techspace Chat Translation added:
*  Spanish (Thank you Ana Ayelen Martinez)

= 4.2.5 2015-01-21 - Low Priority =
* New Feature: You can now view any Techspace Chats you have missed
* New Pro Feature: You can record offline messages when Techspace Chat is not online
* Code Improvements: Labels added to buttons on Techspace Chat window
* Code Improvements: PHP Errors fixed
* Updated Translations:
*  Italian (Thank You Angelo Giammarresi)

= 4.2.4 2014-12-17 - Low Priority = 
* New feature: The Techspace Chat window can be hidden when offline (Pro only)
...
* You can now toggle between displaying or hiding the users name in your Techspace Chat messages
* You can now choose to display the Techspace Chat window to all or only registered users
* A user image will now display in the Techspace Chat message
* jQuery UI CSS is loaded from a local source
* Bug Fix: Only Admin users can make users Techspace Chat agents
* Translations added:
...
* Bug Fix: PHP error on agent side in Techspace Chat window
...
* New Pro Feature: You can now include or exclude the Techspace Chat window on certain pages
...
* Bug fix: sound was not played when user received a Techspace Chat message from the admin
* Internationalization update
* New Techspace Chat Translation added: Swedish (Thank You Tobias Sernhede)

= 4.1.6 2014-09-25 - Low priority =
* Techspace Chat translations added: Hebrew, German, Slovakian
...
= 4.1.1 2014-07-29 =
* Significant performance improvements
* Techspace Chat window will now only show in one window (if user has multiple tabs open on your site)
* You can now see the browser of the Techspace Chat user
* Improved the UI of the backend
* Bug fixes

= 4.1.0 2014-07-20 =
* New feature: You can now show the Techspace Chat box on the left or right
...
* Fixed IE8 bug
* Added option to auto pop up Techspace Chat window
...
= 4.0.0 = 
* Overhauled the Techspace Chat Ajax calls to be less resource intensive
* Fixed many localization strings
* Added Feedback Page
* Added Welcome Page
* Fixed Visitor pending forever - Now Shown a message that admin is away
* Fixed many small bugs
* Added Multiple Techspace Chat Agents support (Add On)
...
= 2.7 =
* Fixed the Techspace Chat initiation bug
* Fixed the style bug
* Added support to email for proper smtp (pro)
* Fixed cookie bugs
* Add delete Techspace Chat history option (pro)
* Added UTF8 character support for the Techspace Chat
* Added error reporting (pro)

= 2.6 =
* Fixed a bug that showed 'page not found' when saving the Techspace Chat settings
* Better UI
* Added the ability to end Techspace Chats
...
= 2.4 =
* You now have full control of the fill and font color of your Techspace Chat box
* Added the ability to turn Techspace Chat on and off
* Better notification of incoming Techspace Chats.
