...
/* Handles all functions related to the Techspace Chat API */

/*
 * Accepts a chat within the Techspace Chat Dashboard
...
/*
 * Ends a chat within the Techspace Chat Dashboard
 * Required GET/POST variables:
 * - Token 
 * - Chat ID
 * - Agent ID 
...
/*
 * Send a message to a chat within the Techspace Chat Dashboard
 * Required GET/POST variables:
 * - Token 
 * - Chat ID
 * - Message
...
/*
 * Fetch a chat status within the Techspace Chat Dashboard
 * Required GET/POST variables:
 * - Token 
 * - Chat ID
*/
...
/*
 * Fetch a chat sessions within the Techspace Chat Dashboard
 * Required GET/POST variables:
 * - Token 
*/
