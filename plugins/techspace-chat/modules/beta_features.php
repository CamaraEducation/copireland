   ...
   <div id="tabs-beta">
     ...
     <table class="wp-list-table wplc_list_table widefat fixed striped pages">
       <tbody>
         ...
         <tr>
           <td width="250" valign="top">
             <label for="wplc_end_point_override"><?php _e("Server end point override","wplivechat"); ?> <i class="fa fa-question-circle wplc_light_grey wplc_settings_tooltip" title="<?php _e('Do not change this unless advised to do so by a Techspace Chat representative', 'wplivechat'); ?>"></i></label>
           </td>
           <td valign="top">
             <input type="text" value="<?php echo $wplc_end_point_override; ?>" id="wplc_end_point_override" name="wplc_end_point_override" placeholder="<?php _e('Leave empty unless advised by a Techspace Chat representative', 'wplivechat'); ?>">
           </td>
         </tr>
