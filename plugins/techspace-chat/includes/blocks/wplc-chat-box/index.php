...
function wplc_gutenberg_settings_content() {
	...
	$gutenberg_text = ( $gutenberg_settings['wplc_gutenberg_text'] ) ? $gutenberg_settings['wplc_gutenberg_text'] : 'Techspace Chat';
...
function wplc_gutenberg_save_settings() {
    ...
    if (isset($_POST['wplc_save_settings'])) {
        ...
        if (isset($_POST['wplc_gutenberg_text']) && $_POST['wplc_gutenberg_text'] !== '0') {
            ...
            $wplc_gutenberg_data['wplc_gutenberg_text'] = 'Techspace Chat';
        }
...
function wplc_chat_box_block_editor_assets() {
	...
	$settings['wplc_text'] = ( $gutenberg_settings['wplc_gutenberg_text'] ? esc_attr( $gutenberg_settings['wplc_gutenberg_text'] ) : __( 'Techspace Chat', 'wplivechat' ) );
