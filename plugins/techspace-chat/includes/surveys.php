...
function wplc_survey_hook_control_settings_page_more_tabs() {
 ...
 <div id="tabs-survey">            
    ...
    <table class='form-table wp-list-table wplc_list_table widefat fixed striped pages'>
        <tr>
            <td width='300' valign='top'><?php _e("Enable Surveys & Lead Forms", "wplivechat") ?>: <i class="fa fa-question-circle wplc_light_grey wplc_settings_tooltip" title="<?php _e('Enable surveys and lead forms within your Techspace Chat box, either before or after a Techspace Chat session.', 'wplivechat'); ?>"></i></td> 
            <td>
...
function wplc_admin_survey_layout() {
    ...
    echo "<h1>" . __("Techspace Chat Surveys & Lead Forms with Nimble Squirrel", "wplivechat") . "</h1>";
    ...
    $link2 = sprintf( __( '<a href="%s" target="_BLANK" title="Create a survey">Create a survey</a>.', 'wplivechat' ),
        ...
        echo "          <h2>".__("Add a Survey to your Techspace Chat box","wplivechat")."</h2>";
        echo "          <p>".__("Three simple steps:","wplivechat")."</p>";
        echo "          <ol>";
        echo "              <li>".$link1."</li>";
        echo "              <li>".$link2."</li>";
        echo "              <li>".__("Enable surveys in your Techspace Chat <a href='admin.php?page=wplivechat-menu-settings#tabs-survey'>settings page</a>.","wplivechat")."</li>";
        echo "          </ol>";
        echo "";
        echo "";
        echo "      </div>";
