...
<div class="wrap wplc_wrap" style='display: none;'>
    ...
    <h2><?php _e("Techspace Chat Settings","wplivechat")?></h2>
    <?php
      ...
      <div id="tabs-1">
          ...
          <table class='wp-list-table wplc_list_table widefat fixed striped pages' width='700'>
              ...
              <tr>
                ...
                <?php _e("Show the 'Powered by Techspace Chat' link", "wplivechat") ?>: <i class="fa fa-question-circle wplc_light_grey wplc_settings_tooltip" title="<?php _e('Checking this will display a Powered by Techspace Chat link', 'wplivechat'); ?>"></i>
                </td>
                <td>
