...
<p>&nbsp;</p>
<h1 style='margin-right: 0;'><?php _e("Welcome to Techspace Chat v8","wplivechat"); ?> <div class="wplc-badge" style=' float: right; display: block; max-width: 20%; margin-left: 15%;'><img src='<?php echo WPLC_BASIC_PLUGIN_URL . "images/wplc-logo.png"; ?>' /></div></h1>

<div class="about-text"><?php _e("Techspace Chat is the most cost effective, feature rich, amazingly supported and most positively reviewed Techspace Chat plugin on WordPress!","wplivechat"); ?></div>
...
<div class="feature-section normal clear" >
    <div class="changelog ">
        ...
        <div class="feature-section three-col">
            <div class='col'>
                <h4><?php _e("New to Techspace Chat?","wplivechat"); ?></h4>
