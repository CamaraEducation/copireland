...
jQuery(document).on("bleeper_dom_ready", function(e) {
     ...
     *
     * Takes over the 'add agent' event and adds our own data to it. In this case we add the agent's data so that it can be displayed in the header section of the Techspace Chat box on the front end
     *
     * @return void
     */
