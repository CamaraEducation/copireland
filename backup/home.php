...
<?php echo get_avatar($current_user->ID, 64); ?>
        ...
        <?php
            ...
            <h1> 
            <?php
 echo $currentPathway; ?>  Activities </h1>
<?php
}
?>
    </section>
...
<section>
        <div class="container">
            <h2 class="btitle"><?php echo $currentPathway;?> Starter Kit</h2>
            <hr>
        </div>
        <div class="container">
            <div class="row">
...
?>
    ...
    <section>
        <div class="container">
                    <hs2 class="btitle"><?php echo $currentPathway ?> Activities</hs2>
                </div>
            <hr>
...
?>
                ...
                <img src="<?php echo gettermImage($currentPathway); ?>" width="35" height="43">
